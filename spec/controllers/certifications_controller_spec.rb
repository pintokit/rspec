  ...
  describe "POST #create" do
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved certification as @certification" do
        post :create, {:certification => invalid_attributes}, valid_session
        expect(assigns(:certification)).to be_a_new(Certification)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested certification" do
        certification = Certification.create! valid_attributes
        put :update, {:id => certification.to_param, :certification => new_attributes}, valid_session
    ...
    context "with invalid params" do
      it "assigns the certification as @certification" do
        certification = Certification.create! valid_attributes
        put :update, {:id => certification.to_param, :certification => invalid_attributes}, valid_session
        expect(assigns(:certification)).to eq(certification)
      end
